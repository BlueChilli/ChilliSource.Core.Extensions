...
namespace ChilliSource.Core.Extensions
{
    ...
    public static partial class GeometryExtensions
    {
        ...
        public static float ToDegrees(this float radians) => (float)ToDegrees((double)radians);
        ...
        public static float ToRadians(this float degrees) => (float)ToRadians((double)degrees);
