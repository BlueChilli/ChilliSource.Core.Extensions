...
namespace ChilliSource.Core.Extensions
{
    ...
    public static class UriExtensions
    {
        ...
        /// <summary>
        /// Gets the root of the specified System.Uri (everything except the path and the query string)
        /// </summary>
        /// <param name="uri">A System.Uri.</param>
        ...
        /// <summary>
        /// Gets the base of the specified System.Uri (everything except the query string)
        /// </summary>
        /// <param name="uri">A System.Uri.</param>
